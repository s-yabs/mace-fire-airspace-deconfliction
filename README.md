...
- Draws active volumes to a MACE vector layer named `Fire Airspace`.
...
- The volume is a rectangular corridor along the gun-target line with vertical limits from ground/target MSL to max ordinate MSL.
